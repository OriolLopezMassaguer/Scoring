...
trait WebPlotHighcharts extends WebPlot[Highchart] {
  ...
  val port_js_server = scoring.Scoring.port_js_server
  val wispJsImports: String =
    s"""
      |<script type="text/javascript" src="http://localhost:$port_js_server/js/jquery-1.8.2.min.js"></script>
      |<script type="text/javascript" src="http://localhost:$port_js_server/js/highcharts.js"></script>
      |<script type="text/javascript" src="http://localhost:$port_js_server/js/exporting.js"></script>
      |<script type="text/javascript" src="http://localhost:$port_js_server/js/highcharts-more.js"></script>
    """.stripMargin

  val wispJsImportsweb: String =
    """
