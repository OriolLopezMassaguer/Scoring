...
set "APP_CLASSPATH=%APP_LIB_DIR%\default.scoring-1.0.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.11.7.jar;%APP_LIB_DIR%\com.github.scopt.scopt_2.11-3.3.0.jar"
